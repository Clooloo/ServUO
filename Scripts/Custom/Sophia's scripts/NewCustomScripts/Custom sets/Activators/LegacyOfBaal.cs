...
{
    public class BaalLegacy : Item
    {

        [Constructable]
        public BaalLegacy() : base( 0x2AAA )
        {
            Movable = true;
            Hue = 2176;
            Weight = 25.0;
            Name = "Baal's legacy Set";
        }
        public override void GetProperties(ObjectPropertyList list)
            ...
            list.Add("Double click to feel the darkness power...");
            }
        ...
        public override void OnDoubleClick( Mobile from )
        {
            ...
            //{  
                ...
                Item EquipArmor6 = from.FindItemOnLayer(Layer.Helm);
                Item EquipArmor7 = from.FindItemOnLayer(Layer.Cloak);//Layer.Cloak
               
 
                if (EquipArmor1 is LegsOfBaal || EquipArmor2 is GauntletsOfBaal || EquipArmor3 is BreastplateOfBaal ||
                    EquipArmor4 is ArmsOfBaal || EquipArmor5 is GorgetOfBaal || EquipArmor6 is HelmOfBaal || EquipArmor3 is Baalcloak)
                {
                 ...
                 else if (EquipArmor1 is BardLegs || EquipArmor1 is WorkerLegs || EquipArmor1 is NaturalLegs || EquipArmor1 is RigorLegs)
                {
      ...
      return;
                ...
                from.EquipItem(new LegsOfBaal());
                from.EquipItem(new GauntletsOfBaal());
                from.EquipItem(new BreastplateOfBaal());
                from.EquipItem(new ArmsOfBaal());
                from.EquipItem(new GorgetOfBaal());
                from.EquipItem(new HelmOfBaal());
        ...
        public BaalLegacy( Serial serial ) : base( serial )
        {
        }
