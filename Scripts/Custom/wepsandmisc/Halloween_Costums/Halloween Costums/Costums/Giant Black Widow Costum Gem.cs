...
{
	public class HalloweenCostumFour : Item
	{
		int bodyadjust = 0;

		[Constructable]
		public HalloweenCostumFour() : base( 0xF13 )
		{
			Movable = true;
			Name = "Giant Black Widow Gem";
		}

		public HalloweenCostumFour(Serial serial) : base(serial){}
