...
{ 
   ...
   { 
         ...
         SetSkill( SkillName.Magery, 250 );
         SetSkill( SkillName.Parry, 120 );
         SetSkill( SkillName.Meditation, 100 );   
		 SetSkill( SkillName.Swords, 200 );
		 SetSkill( SkillName.Tactics, 200 );
                                    
         
        PackItem( new Bandage( 1000 ) );
		PackItem( new Gold( 60000) );


		switch ( Utility.Random( 3 )) 
			{ 
				case 0: PackItem( new HeadofGwenno() ); break; 
				case 1: PackItem( new SwordofGwenno() ); break;
				case 2: PackItem( new ShieldofGwenno() ); break;
				}
