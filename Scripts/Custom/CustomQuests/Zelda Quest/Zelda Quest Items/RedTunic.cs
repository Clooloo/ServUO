...
namespace Server.Items
{
	...
	{ 
		...
		{
			m_SkillMod0 = new DefaultSkillMod( SkillName.AnimalTaming, true, 30 ); 
			m_SkillMod1 = new DefaultSkillMod( SkillName.AnimalLore, true, 30 ); 
			m_SkillMod2 = new DefaultSkillMod( SkillName.Focus, true, 20 ); 
