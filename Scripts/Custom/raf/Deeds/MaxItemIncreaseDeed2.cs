...
{
    public class BackpackMaxItemIncrease2 : Item
	{
		// Maximum bonus these deeds can give is...
		public const int MaxIncreaseCap = 1500;
		...
		[Constructable]
		public BackpackMaxItemIncrease2() : base( 0x14F0 )
		{
			Name = "+1k Max Pack Item Capacity. Cap=1k";
			_AmountToIncrese = 1000; // set the increase in items here
		}
		...
		public BackpackMaxItemIncrease2( Serial serial ) : base( serial )
		{
		}
