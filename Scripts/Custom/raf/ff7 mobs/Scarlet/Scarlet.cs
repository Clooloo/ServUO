...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of Scarlet" )]
              public class Scarlet : BaseCreature
              {
				private Timer m_Timer;
                                 [Constructable]
                                    public Scarlet() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
                            {
                                               Name = "Scarlet";
					             Body = 174;
						        Female = true; 
                                 ...
                                 public override void GenerateLoot()
		{
			...
			{
				case 0: PackItem( new YuffieShirt() ); break;
				case 1: PackItem( new YuffieSkirt() ); break;
				case 2: PackItem( new YuffieSash() ); break;
				case 3: PackItem( new YuffieWep() ); break;
				case 4: PackItem( new YuffieShroud() ); break;
...
public Scarlet( Serial serial ) : base( serial )
                      {
                      }
