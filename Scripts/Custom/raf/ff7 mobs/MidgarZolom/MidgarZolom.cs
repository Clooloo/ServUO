...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of Midgar Zolom" )]
              public class MidgarZolom : BaseCreature
              {
		...
		return Utility.RandomBool() ? WeaponAbility.CrushingBlow : WeaponAbility.ConcussionBlow;
			...
			private Timer m_Timer;
                                 [Constructable]
  public MidgarZolom() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
                            {
                                Name = "Midgar Zolom";
				Body = 91;
				Female = false; 
			...
			PackGold( 20000, 30000 );
	    		...
	    		LucretiaChest Chest = new LucretiaChest();
			Chest.Movable = false;
			AddItem(Chest);
			
			LucretiaArms Arms = new LucretiaArms();
			Arms.Movable = false;
			AddItem(Arms);
			
			LucretiaLegs Legs = new LucretiaLegs();
			Legs.Movable = false;
			AddItem(Legs);
			
			LucretiaGloves Gloves = new LucretiaGloves();
			Gloves.Movable = false;
			AddItem(Gloves);
			
			LucretiaApron HalfApron = new LucretiaApron();
			HalfApron.Movable = false;
			AddItem(HalfApron);
			
			LucretiaHelm Helm = new LucretiaHelm();
			Helm.Movable = false;
			AddItem(Helm);

	    		LucretiaRobe Robe = new LucretiaRobe();
			Robe.Movable = false;
			AddItem(Robe);
                                 ...
                                 public override void GenerateLoot()
		{
			...
			{
		case 0: PackItem( new LucretiaRobe() ); break;
		case 1: PackItem( new LucretiaHelm() ); break;
		case 2: PackItem( new LucretiaLegs() ); break;
		case 3: PackItem( new LucretiaArms() ); break;
		case 4: PackItem( new LucretiaGloves() ); break;
		case 5: PackItem( new LucretiaChest() ); break;
		case 6: PackItem( new LucretiaApron() ); break;
...
public MidgarZolom( Serial serial ) : base( serial )
                      {
                      }
