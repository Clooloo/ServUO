...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of Heidegger" )]
              public class Heidegger : BaseCreature
              {
				private Timer m_Timer;
                                 [Constructable]
                                    public Heidegger() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
                            {
			...
			Item MythrilClip = new MythrilClip(); 
			MythrilClip.Movable = false;
			MythrilClip.Hue = 0; 
			AddItem( MythrilClip );
                                 ...
                                 public override void GenerateLoot()
		{
			...
			{
				case 0: PackItem( new MythrilClip() ); break;
				case 1: PackItem( new RedxIIIClub() ); break;
				case 2: PackItem( new RedxIIIShirt() ); break;
				case 3: PackItem( new RedxIIINeck() ); break;
				case 4: PackItem( new RedxIIILoincloth() ); break;
...
public Heidegger( Serial serial ) : base( serial )
                      {
                      }
