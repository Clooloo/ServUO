...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of Hundred Gunner" )]
              public class HundredGunner : BaseCreature
              {
				private Timer m_Timer;
                                 [Constructable]
                                    public HundredGunner() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
                            {
                                               Name = "Hundred Gunner";
					             Body = 788;
						        Female = false; 
                                 ...
                                 public override void GenerateLoot()
		{
			...
			{
				case 0: PackItem( new ShinraChest() ); break;
				case 1: PackItem( new ShinraArms() ); break;
				case 2: PackItem( new ShinraLegs() ); break;
				case 3: PackItem( new ShinraGloves() ); break;
				case 4: PackItem( new ShinraGorget() ); break;
...
//				public override bool IsScaredOfScaryThings{ get{ return false; } }
		...
		private class TeleportTimer : Timer
		{
			...
			public TeleportTimer( Mobile owner ) : base( TimeSpan.FromSeconds( 10.0 ), TimeSpan.FromSeconds( 15.1 ) )
			{
				m_Owner = owner;
			}
...
public HundredGunner( Serial serial ) : base( serial )
                      {
                      }
