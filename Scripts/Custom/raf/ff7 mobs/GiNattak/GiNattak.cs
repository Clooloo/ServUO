...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of Gi Nattak" )]
              public class GiNattak : BaseCreature
              {

                                 [Constructable]
                                    public GiNattak() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.1, 0.2 )
                            {
                                               Name = "Gi Nattak";
                                               Hue = 1155;
								Paralyzed = false;
...
public override void GenerateLoot()
		{		
			switch ( Utility.Random( 75 ))
			{
				...
				case 0: PackItem( new TsengHelm() ); break;
				case 1: PackItem( new TsengChest() ); break;
				case 2: PackItem( new TsengArms() ); break;
				case 3: PackItem( new TsengGloves() ); break;
				case 4: PackItem( new TsengLegs() ); break;
...
public GiNattak( Serial serial ) : base( serial )
                      {
                      }
