...
{
    public class BarretShield : BronzeShield
    {
	    ...
	    Attributes.ReflectPhysical = Utility.Random( 1, 15 );
            ...
            Attributes.SpellDamage = Utility.Random( 1, 10 );
	    Attributes.WeaponSpeed = Utility.Random( 1, 15 );
        }

        public BarretShield(Serial serial) : base( serial )
        {
        }
