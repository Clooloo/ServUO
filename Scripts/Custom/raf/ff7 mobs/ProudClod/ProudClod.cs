...
namespace Server.Mobiles
              ...
              [CorpseName( " corpse of Proud Clod " )]
              public class ProudClod : BaseCreature
              {
		  ...
		  public override WeaponAbility GetWeaponAbility()
		  {
			return Utility.RandomBool() ? WeaponAbility.Dismount : WeaponAbility.CrushingBlow;
                                 	...
                                 	[Constructable]
                                    public ProudClod() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8 )
                            {
                                               Name = "Proud Clod";
                                               Hue = 1166;
                                               Body = 0x2F5;
			...
			{
		case 0: PackItem( new BarretShield() ); break;
		case 1: PackItem( new BarretChest() ); break;
		case 2: PackItem( new BarretLegs() ); break;
		case 3: PackItem( new BarretArms() ); break;
		case 4: PackItem( new BarretGloves() ); break;
		case 5: PackItem( new BarretHelm() ); break;
		case 6: PackItem( new BarretBow() ); break;
                                            }}    
			    ...
			    public ProudClod( Serial serial ) : base( serial )
                      {
                      }
