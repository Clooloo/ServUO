...
namespace Server.Items
{
	...
	public class HeroHammerPick : BaseBashing
	{
		...
		[Constructable]
		public HeroHammerPick() : base( 0x143D )
		{
			Weight = 7.0;
			Name = "Hero's Hammer Pick";
		...
		{ 
			...
			{ 
                ...
                this.Name = "Hero " + from.Name.ToString() + "'s Hammer Pick";//Change item name and add who it is bound to. "Player's WeaponName"
		...
		public HeroHammerPick( Serial serial ) : base( serial )
		{
		}
