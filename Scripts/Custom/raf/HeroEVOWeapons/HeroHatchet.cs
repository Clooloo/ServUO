...
namespace Server.Items
{
	...
	public class HeroHatchet : BaseAxe
	{
		...
		{ 
			...
			{ 
                ...
                this.Name = "Hero " + from.Name.ToString() + "'s Hatchet";//Change item name and add who it is bound to. "Player's WeaponName"
        ...
        public void ApplyGain()
        {
            ...
            if (mEvolutionPoints < 10001)//5001 restricts evolving to 50% and 10001 is 100%
            {
                ...
                if ((25 + (mEvolutionPoints / 200)) > 0) this.Attributes.WeaponSpeed = (0 + (mEvolutionPoints / 400));
		...
		public HeroHatchet( Serial serial ) : base( serial )
		{
		}
