...
namespace Server.Items
{
	...
	public class HeroDblAxe : BaseAxe
	{
		...
		[Constructable]
		public HeroDblAxe() : base( 0xF4B )
		{
			Weight = 7.0;
			Name = "Hero's Double Axe";
            ...
            SkillBonuses.SetValues(0, SkillName.Lumberjacking, 15);             
		...
		{ 
			...
			{ 
                ...
                this.Name = "Hero " + from.Name.ToString() + "'s Double Axe";//Change item name and add who it is bound to. "Player's WeaponName"
        ...
        {
            if ( from.Skills[SkillName.Swords].Base < 125.0 )
			{
		...
		public HeroDblAxe( Serial serial ) : base( serial )
		{
		}
