...
namespace Server.Items
{
	...
	public class HeroBlackStaff : BaseStaff
	{
		...
		[Constructable]
		public HeroBlackStaff() : base( 0xdf1 )
		{
			Weight = 7.0;
			Name = "Hero's Black Staff";
            ...
            SkillBonuses.SetValues(0, SkillName.Tactics, 30);
		...
		{ 
			...
			{ 
                ...
                this.Name = "Hero " + from.Name.ToString() + "'s Black Staff";//Change item name and add who it is bound to. "Player's WeaponName"
        ...
        public void ApplyGain()
        {
            ...
            if (mEvolutionPoints < 10001)//5001 restricts evolving to 50% and 10001 is 100%
            {
                ...
                if ((mEvolutionPoints / 100) > 0)
                {
                    ...
                    this.WeaponAttributes.HitColdArea = expr;
                    this.WeaponAttributes.HitFireArea = expr;
                }
        ...
        {
            if ( from.Skills[SkillName.Macing].Base < 125.0 )
			{
		...
		public HeroBlackStaff( Serial serial ) : base( serial )
		{
		}
