...
namespace Server.Items
{
	...
	public class HeroSpear : BaseSpear
	{
		...
		{ 
			...
			{ 
                ...
                this.Name = "Hero " + from.Name.ToString() + "'s Spear";//Change item name and add who it is bound to. "Player's WeaponName"
        ...
        {
            if ( from.Skills[SkillName.Fencing].Base < 125.0 )
			{
		...
		public HeroSpear( Serial serial ) : base( serial )
		{
		}
