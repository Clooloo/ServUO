...
namespace Server.Items
{
	...
	public class HerohoodedRobe : Robe
	{
        public override int InitMinHits { get { return 100; } }
        public override int InitMaxHits { get { return 100; } }

		[Constructable]
		public HerohoodedRobe()
		{
            ItemID = 9860;
	    Weight = 40.0;
            Name = "Hero's Hooded Robe";
            Hue = 1153;
        ...
        public HerohoodedRobe(Serial serial): base(serial)
		{
		}
		...
		{
            Item y = from.Backpack.FindItemByType(typeof(HerohoodedRobe));
			if ( y !=null )
			{

                if (this.ItemID == 9860) this.ItemID = 39301;
                else if (this.ItemID == 39301) this.ItemID = 9860;
