...
{
    public class HerosTamerBracelet2 : GoldBracelet
    {
        ...
        [Constructable]
        public HerosTamerBracelet2()
        {
			this.Name = "Hero Tamer's Bracelet";
			this.Hue = 1954;
			...
			SkillBonuses.SetValues(3, SkillName.EvalInt, 20.0);
        }
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Tamer Bracelet";//Change item name and add who it is bound to. "Player's Hero Warrior Bracelet"
        ...
        public HerosTamerBracelet2(Serial serial)
            : base(serial)
        {
        }
