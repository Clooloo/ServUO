...
{
    public class HerosTamerArms2 : BoneArms
    {
        ...
        [Constructable]
        public HerosTamerArms2()
        {
			this.Name = "Hero Tamer's Arms";
			this.Hue = 1954;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Tamer Arms";//Change item name and add who it is bound to. "Player's Hero Warrior Arms"
        ...
        public HerosTamerArms2(Serial serial)
            : base(serial)
        {
        }
