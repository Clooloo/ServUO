...
{
    public class HerosTamerRobe2 : Robe
    {
        ...
        [Constructable]
        public HerosTamerRobe2()
        {
			this.Name = "Hero Tamer's Robe";
			this.Hue = 1954;
			this.ItemID = 0x27A0;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Tamer Robe";//Change item name and add who it is bound to. "Player's Hero Warrior Robe"
        ...
        public HerosTamerRobe2(Serial serial)
            : base(serial)
        {
        }
