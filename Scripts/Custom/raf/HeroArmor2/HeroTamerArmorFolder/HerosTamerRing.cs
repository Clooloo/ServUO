...
{
    public class HerosTamerRing2 : GoldRing
    {
        ...
        [Constructable]
        public HerosTamerRing2()
        {
			this.Name = "Hero Tamer's Ecru Ring";
			this.Hue = 1954;
			...
			SkillBonuses.SetValues(1, SkillName.Veterinary, 35.0);
			SkillBonuses.SetValues(2, SkillName.Peacemaking, 25.0);
			SkillBonuses.SetValues(3, SkillName.Bushido, 25.0);
        }
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Tamer Ecru Ring";//Change item name and add who it is bound to. "Player's Hero Warrior Ecru Ring"
        ...
        public HerosTamerRing2(Serial serial)
            : base(serial)
        {
        }
