...
{
    public class HerosTamerEarrings2 : GoldEarrings
    {
        ...
        [Constructable]
        public HerosTamerEarrings2()
        {
			this.Name = "Hero Tamer's Earrings";
			this.Hue = 1954;
			...
			SkillBonuses.SetValues(4, SkillName.EvalInt, 20.0);
        }
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Tamer Earrings";//Change item name and add who it is bound to. "Player's Hero Warrior Earrings"
        ...
        public HerosTamerEarrings2(Serial serial)
            : base(serial)
        {
        }
