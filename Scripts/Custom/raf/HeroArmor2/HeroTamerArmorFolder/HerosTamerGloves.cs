...
{
    public class HerosTamerGloves2 : BoneGloves
    {
        ...
        [Constructable]
        public HerosTamerGloves2()
        {
			this.Name = "Hero Tamer's Bone Gloves";
			this.Hue = 1954;
			...
			SkillBonuses.SetValues(0, SkillName.Mysticism, 30);
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Tamer Gloves";//Change item name and add who it is bound to. "Player's Hero Warrior Gloves"
        ...
        public HerosTamerGloves2(Serial serial)
            : base(serial)
        {
        }
