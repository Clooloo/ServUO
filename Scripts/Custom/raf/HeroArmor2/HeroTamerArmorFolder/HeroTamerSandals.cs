...
{
    public class HerosTamerSandals2 : Sandals
    {
        ...
        [Constructable]
        public HerosTamerSandals2()
        {
			this.Name = "Hero Tamer's Sandals";
			this.Hue = 1954;
			...
			SkillBonuses.SetValues(0, SkillName.Veterinary, 35.0);
			SkillBonuses.SetValues(1, SkillName.Bushido, 25.0);
			SkillBonuses.SetValues(2, SkillName.Musicianship, 30.0);
			SkillBonuses.SetValues(3, SkillName.AnimalTaming, 10.0);
			SkillBonuses.SetValues(4, SkillName.AnimalLore, 10.0);			
        }
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Tamer Sandals";//Change item name and add who it is bound to. "Player's Hero Warrior Sandals"
        ...
        public HerosTamerSandals2(Serial serial)
            : base(serial)
        {
        }
