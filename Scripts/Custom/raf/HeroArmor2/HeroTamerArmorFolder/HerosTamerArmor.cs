...
{
    public class HerosTamerArmor2 : BoneChest
    {
        ...
        [Constructable]
        public HerosTamerArmor2()
        {
			this.Name = "Hero Tamer's Chest";
			this.Hue = 1954;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Tamer Chest";//Change item name and add who it is bound to. "Player's Hero Magi Chest"
        ...
        public HerosTamerArmor2(Serial serial)
            : base(serial)
        {
        }
