...
{
    public class HerosHerdingCrook2 : ShepherdsCrook
    {
        ...
        [Constructable]
        public HerosHerdingCrook2()
        {
			this.Name = "Hero's Herding Crook";
			this.Hue = 2411;
			
			this.Attributes.Luck = 100;
			this.WeaponAttributes.MageWeapon = 65;
			...
			SkillBonuses.SetValues(0, SkillName.Mysticism, 45.0);
			SkillBonuses.SetValues(1, SkillName.Bushido, 30.0);
			SkillBonuses.SetValues(2, SkillName.Focus, 25.0);
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Herding Crook";//Change item name and add who it is bound to. "Player's Hero Magi Chest"
        ...
        public HerosHerdingCrook2(Serial serial)
            : base(serial)
        {
        }
