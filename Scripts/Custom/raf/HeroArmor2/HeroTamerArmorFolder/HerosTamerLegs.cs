...
{
    public class HerosTamerLeggings2 : BoneLegs
    {
        ...
        public HerosTamerLeggings2()
        {
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Tamer Legs";//Change item name and add who it is bound to. "Player's Hero Warrior Legs"
        ...
        public HerosTamerLeggings2(Serial serial)
            : base(serial)
        {
        }
