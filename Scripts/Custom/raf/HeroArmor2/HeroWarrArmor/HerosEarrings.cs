...
{
    public class HerosEarrings2 : GoldEarrings
    {
        ...
        [Constructable]
        public HerosEarrings2()
        {
			this.Name = "Hero Warrior's Earrings";
			this.Hue = 1955;
			...
			SkillBonuses.SetValues(2, SkillName.Bushido, 50.0);
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Warrior Earrings";//Change item name and add who it is bound to. "Player's Hero Warrior Earrings"
        ...
        public HerosEarrings2(Serial serial)
            : base(serial)
        {
        }
