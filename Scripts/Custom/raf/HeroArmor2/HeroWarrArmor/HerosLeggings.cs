...
{
    public class HerosLeggings2 : BoneLegs
    {
        ...
        [Constructable]
        public HerosLeggings2()
        {
			this.Name = "Hero Warrior's Bone Legs";
			this.Hue = 1955;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Warrior Legs";//Change item name and add who it is bound to. "Player's Hero Warrior Legs"
        ...
        public HerosLeggings2(Serial serial)
            : base(serial)
        {
        }
