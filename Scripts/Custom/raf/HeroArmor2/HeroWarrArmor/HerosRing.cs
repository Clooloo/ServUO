...
{
    public class HerosRing2 : GoldRing
    {
        ...
        public HerosRing2()
        {
			this.Name = "Hero Warrior's Ecru Ring";
			this.Hue = 1955;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Warrior Ecru Ring";//Change item name and add who it is bound to. "Player's Hero Warrior Ecru Ring"
        ...
        public HerosRing2(Serial serial)
            : base(serial)
        {
        }
