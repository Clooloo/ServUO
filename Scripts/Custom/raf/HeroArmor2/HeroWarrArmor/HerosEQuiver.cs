...
{
    public class HerosEQuiver2 : BaseQuiver
    {
        ...
        [Constructable]
        public HerosEQuiver2()
        {
			this.Name = "Hero Warrior's Elite Quiver";
			this.Hue = 1955;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Elite Warrior Quiver";//Change item name and add who it is bound to. "Player's Elite Warrior Quiver"
        ...
        public HerosEQuiver2(Serial serial)
            : base(serial)
        {
        }
