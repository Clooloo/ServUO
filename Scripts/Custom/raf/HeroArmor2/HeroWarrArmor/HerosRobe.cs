...
namespace Server.Items
{
    public class HerosRobe2 : Robe
    {
        ...
        public HerosRobe2()
        {
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Warrior Robe";//Change item name and add who it is bound to. "Player's Hero Warrior Robe"
        ...
        public HerosRobe2(Serial serial)
            : base(serial)
        {
        }
