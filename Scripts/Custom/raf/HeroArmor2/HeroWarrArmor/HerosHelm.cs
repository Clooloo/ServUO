...
{
    public class HerosHelm2 : BoneHelm
    {
        ...
        public HerosHelm2()
        {
			this.Name = "Hero Warrior's Bone Mask";
			this.Hue = 1955;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Warrior Mask";//Change item name and add who it is bound to. "Player's Hero Warrior Mask"
        ...
        public HerosHelm2(Serial serial)
            : base(serial)
        {
        }
