...
{
    public class HerosArms2 : BoneArms
    {
        ...
        public HerosArms2()
        {
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Warrior Arms";//Change item name and add who it is bound to. "Player's Hero Warrior Arms"
        ...
        public HerosArms2(Serial serial)
            : base(serial)
        {
        }
