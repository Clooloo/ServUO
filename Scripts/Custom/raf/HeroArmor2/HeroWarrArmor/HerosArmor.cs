...
{
    public class HerosArmor2 : BoneChest
    {
        ...
        public HerosArmor2()
        {
			this.Name = "Hero Warrior's Bone Chest";
			this.Hue = 1955;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Warrior Chest";//Change item name and add who it is bound to. "Player's Hero Warrior Chest"
        ...
        public HerosArmor2(Serial serial)
            : base(serial)
        {
        }
