...
{
    public class HerosMagiRobe2 : Robe
    {
        ...
        [Constructable]
        public HerosMagiRobe2()
        {
			this.Name = "Hero Magi's Robe";
			this.Hue = 1954;
			this.ItemID = 0x27A0;
            ...
            SkillBonuses.SetValues(4, SkillName.Wrestling, 30);
        }
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Magi Robe";//Change item name and add who it is bound to. "Player's Hero Warrior Robe"
        ...
        public HerosMagiRobe2(Serial serial)
            : base(serial)
        {
        }
