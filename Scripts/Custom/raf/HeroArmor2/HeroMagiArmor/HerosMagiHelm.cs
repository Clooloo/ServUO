...
{
    public class HerosMagiHelm2 : BoneHelm
    {
        ...
        [Constructable]
        public HerosMagiHelm2()
        {
			this.Name = "Hero Magi's Bone Mask";
			this.Hue = 1954;
            ...
            this.AbsorptionAttributes.ResonanceEnergy = 20;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Magi Mask";//Change item name and add who it is bound to. "Player's Hero Warrior Mask"
        ...
        public HerosMagiHelm2(Serial serial)
            : base(serial)
        {
        }
