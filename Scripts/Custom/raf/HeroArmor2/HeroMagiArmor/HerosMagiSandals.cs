...
{
    public class HerosMagiSandals2 : Sandals
    {
        ...
        [Constructable]
        public HerosMagiSandals2()
        {
			this.Name = "Hero Magi's Sandals";
			this.Hue = 1954;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Magi Sandals";//Change item name and add who it is bound to. "Player's Hero Warrior Sandals"
        ...
        public HerosMagiSandals2(Serial serial)
            : base(serial)
        {
        }
