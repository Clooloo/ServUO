...
{
    public class HerosMagiArms2 : BoneArms
    {
        ...
        [Constructable]
        public HerosMagiArms2()
        {
			this.Name = "Hero Magi's Arms";
			this.Hue = 1954;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Magi Arms";//Change item name and add who it is bound to. "Player's Hero Warrior Arms"
        ...
        public HerosMagiArms2(Serial serial)
            : base(serial)
        {
        }
