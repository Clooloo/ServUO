...
{
    public class HerosMagiArmor2 : BoneChest
    {
        ...
        [Constructable]
        public HerosMagiArmor2()
        {
			this.Name = "Hero Magi's Chest";
			this.Hue = 1954;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Magi Chest";//Change item name and add who it is bound to. "Player's Hero Magi Chest"
        ...
        public HerosMagiArmor2(Serial serial)
            : base(serial)
        {
        }
