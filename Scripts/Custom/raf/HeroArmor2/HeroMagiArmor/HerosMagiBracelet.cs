...
{
    public class HerosMagiBracelet2 : GoldBracelet
    {
        ...
        [Constructable]
        public HerosMagiBracelet2()
        {
			this.Name = "Hero Magi's Bracelet";
			this.Hue = 1954;
			...
			this.AbsorptionAttributes.EaterKinetic = 30;
            this.AbsorptionAttributes.ResonanceKinetic = 20;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Magi Bracelet";//Change item name and add who it is bound to. "Player's Hero Warrior Bracelet"
        ...
        public HerosMagiBracelet2(Serial serial)
            : base(serial)
        {
        }
