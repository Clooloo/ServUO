...
{
    public class HerosMagiRing2 : GoldRing
    {
        ...
        [Constructable]
        public HerosMagiRing2()
        {
			this.Name = "Hero Magi's Ring";
			this.Hue = 1954;
			
			this.AbsorptionAttributes.EaterFire = 30;
			this.AbsorptionAttributes.ResonanceFire = 20;				
			...
			this.Attributes.EnhancePotions = 100;
			
			SkillBonuses.SetValues(0, SkillName.EvalInt, 15.0);
			SkillBonuses.SetValues(1, SkillName.Focus, 65.0);
			SkillBonuses.SetValues(2, SkillName.Parry, 50.0);
			SkillBonuses.SetValues(3, SkillName.SpiritSpeak, 50.0);
        }
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Magi Ecru Ring";//Change item name and add who it is bound to. "Player's Hero Warrior Ecru Ring"
        ...
        public HerosMagiRing2(Serial serial)
            : base(serial)
        {
        }
