...
{
    public class HerosMagiEarrings2 : GoldEarrings
    {
        ...
        [Constructable]
        public HerosMagiEarrings2()
        {
			this.Name = "Hero Magi's Earrings";
			this.Hue = 1954;
            ...
            this.AbsorptionAttributes.ResonancePoison = 20;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Magi Earrings";//Change item name and add who it is bound to. "Player's Hero Warrior Earrings"
        ...
        public HerosMagiEarrings2(Serial serial)
            : base(serial)
        {
        }
