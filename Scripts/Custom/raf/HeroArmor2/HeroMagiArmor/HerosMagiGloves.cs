...
{
    public class HerosMagiGloves2 : BoneGloves
    {
        ...
        [Constructable]
        public HerosMagiGloves2()
        {
			this.Name = "Hero Magi's Bone Gloves";
			this.Hue = 1954;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Magi Gloves";//Change item name and add who it is bound to. "Player's Hero Warrior Gloves"
        ...
        public HerosMagiGloves2(Serial serial)
            : base(serial)
        {
        }
