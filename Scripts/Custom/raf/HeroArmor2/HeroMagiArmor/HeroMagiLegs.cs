...
{
    public class HerosMagiLeggings2 : BoneLegs
    {
        ...
        [Constructable]
        public HerosMagiLeggings2()
        {
			this.Name = "Hero Magi's Legs";
			this.Hue = 1954;
			
			this.LootType = LootType.Blessed;
			this.Attributes.CastRecovery = 3;
			this.Attributes.CastSpeed = 2;
            this.AbsorptionAttributes.CastingFocus = 6;
			this.ArmorAttributes.MageArmor = 1;
			this.Attributes.Luck = 300;
			this.Attributes.LowerManaCost = 8;
            this.AbsorptionAttributes.CastingFocus = 5;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Magi Legs";//Change item name and add who it is bound to. "Player's Hero Warrior Legs"
        ...
        public HerosMagiLeggings2(Serial serial)
            : base(serial)
        {
        }
