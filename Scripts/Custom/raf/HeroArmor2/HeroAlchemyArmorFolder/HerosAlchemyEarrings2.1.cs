...
{
    public class HerosAlchemyEarrings2 : GoldEarrings
    {
        ...
        [Constructable]
        public HerosAlchemyEarrings2()
        {
			this.Name = "Hero Chemist's Earrings";
			this.Hue = 2411;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Chemist Earrings";//Change item name and add who it is bound to. "Player's Hero Warrior Earrings"
        ...
        public HerosAlchemyEarrings2(Serial serial)
            : base(serial)
        {
        }
