...
{
    public class HerosEcruChemistRing2 : GoldRing
    {
        ...
        [Constructable]
        public HerosEcruChemistRing2()
        {
			this.Name = "Hero's Ecru Chemist Ring";
			this.Hue = 2411;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Ecru Chemist Ring";//Change item name and add who it is bound to. "Player's Hero Warrior Ecru Ring"
        ...
        public HerosEcruChemistRing2(Serial serial)
            : base(serial)
        {
        }
