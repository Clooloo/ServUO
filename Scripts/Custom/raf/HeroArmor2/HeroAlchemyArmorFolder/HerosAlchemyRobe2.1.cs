...
{
    public class HerosAlchemyRobe2 : Robe
    {
        ...
        [Constructable]
        public HerosAlchemyRobe2()
        {
			this.Name = "Hero Chemist's Robe";
			this.ItemID = 0x27A0;			
			this.Hue = 2411;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Chemist Robe";//Change item name and add who it is bound to. "Player's Hero Warrior Robe"
        ...
        public HerosAlchemyRobe2(Serial serial)
            : base(serial)
        {
        }
