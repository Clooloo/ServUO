...
{
    public class HerosAlchemyArms2 : BoneArms
    {
        ...
        [Constructable]
        public HerosAlchemyArms2()
        {
			this.Name = "Hero Chemist's Arms";
			this.Hue = 2411;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Chemist Arms";//Change item name and add who it is bound to. "Player's Hero Warrior Arms"
        ...
        public HerosAlchemyArms2(Serial serial)
            : base(serial)
        {
        }
