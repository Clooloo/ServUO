...
{
    public class HerosAlchemyLeggings2 : BoneLegs
    {
        ...
        [Constructable]
        public HerosAlchemyLeggings2()
        {
			this.Name = "Hero Tamer's Legs";
			this.Hue = 2411;
			...
			SkillBonuses.SetValues(1, SkillName.Magery, 25.0);
			SkillBonuses.SetValues(2, SkillName.Mysticism, 25.0);
			SkillBonuses.SetValues(3, SkillName.Focus, 25.0);			
        }
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Chemist Legs";//Change item name and add who it is bound to. "Player's Hero Warrior Legs"
        ...
        public HerosAlchemyLeggings2(Serial serial)
            : base(serial)
        {
        }
