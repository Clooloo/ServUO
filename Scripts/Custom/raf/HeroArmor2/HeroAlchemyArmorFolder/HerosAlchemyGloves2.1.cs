...
{
    public class HerosAlchemyGloves2 : BoneGloves
    {
        ...
        [Constructable]
        public HerosAlchemyGloves2()
        {
			this.Name = "Hero Chemist's Bone Gloves";
			this.Hue = 2411;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Chemist Gloves";//Change item name and add who it is bound to. "Player's Hero Warrior Gloves"
        ...
        public HerosAlchemyGloves2(Serial serial)
            : base(serial)
        {
        }
