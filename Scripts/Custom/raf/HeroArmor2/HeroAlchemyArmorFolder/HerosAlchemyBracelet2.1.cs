...
{
    public class HerosBauble2 : GoldBracelet
    {
        ...
        public HerosBauble2()
        {
			this.Name = "Hero Chemist's Bauble";
			this.Hue = 2411;
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Chemist Bauble";//Change item name and add who it is bound to. "Player's Hero Warrior Bracelet"
        ...
        public HerosBauble2(Serial serial)
            : base(serial)
        {
        }
