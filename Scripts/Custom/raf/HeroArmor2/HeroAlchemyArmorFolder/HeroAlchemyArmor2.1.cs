...
{
    public class HerosAlchemyArmor2 : BoneChest
    {
        ...
        [Constructable]
        public HerosAlchemyArmor2()
        {
			this.Name = "Hero Alchemists Chest";
			this.Hue = 2411;
			...
			SkillBonuses.SetValues(2, SkillName.Mysticism, 15.0);
		    ...
		    { 
			    ...
			    { 
                    ...
                    this.Name = from.Name.ToString() + "'s Hero Chemist Chest";//Change item name and add who it is bound to. "Player's Hero Magi Chest"
        ...
        public HerosAlchemyArmor2(Serial serial)
            : base(serial)
        {
        }
