...
{
	public class ChampionPowerScroll130 : Item
	{
		[Constructable]
		public ChampionPowerScroll130() : base( 0x14F0 )
		{
			Name = "Champion Power Scroll 130";
			Weight = 1.0;
			Hue = 88;
			ItemID = 8707;
		}
		
		public ChampionPowerScroll130( Serial serial ) : base( serial ) { }
		...
		private class PowerScrollPicker : Gump
		{
			...
			private ChampionPowerScroll130 m_Deed;

			public PowerScrollPicker(Mobile from , ChampionPowerScroll130 deed) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
				...
				AddLabel(128, 17, 52, @"Choose  a  130  Power  Scroll");
			...
			public override void OnResponse(NetState sender, RelayInfo info)
			{
				...
				{
					case 0: return;
					case 1: scroll = new PowerScroll(SkillName.Alchemy, 130.0) ; break;
					case 2: scroll = new PowerScroll(SkillName.Anatomy, 130.0) ; break;
					case 3: scroll = new PowerScroll(SkillName.AnimalLore, 130.0) ; break;
					case 4: scroll = new PowerScroll(SkillName.AnimalTaming, 130.0) ; break;
					case 5: scroll = new PowerScroll(SkillName.Archery, 130.0) ; break;
					case 6: scroll = new PowerScroll(SkillName.ArmsLore, 130.0) ; break;
					case 7: scroll = new PowerScroll(SkillName.Begging, 130.0) ; break;
					case 8: scroll = new PowerScroll(SkillName.Blacksmith, 130.0) ; break;
					case 9: scroll = new PowerScroll(SkillName.Bushido, 130.0) ; break;
					case 10: scroll = new PowerScroll(SkillName.Camping, 130.0) ; break;
					case 11: scroll = new PowerScroll(SkillName.Carpentry, 130.0) ; break;
					case 12: scroll = new PowerScroll(SkillName.Cartography, 130.0) ; break;
					case 13: scroll = new PowerScroll(SkillName.Chivalry, 130.0) ; break;
					case 14: scroll = new PowerScroll(SkillName.Cooking, 130.0) ; break;
					case 15: scroll = new PowerScroll(SkillName.DetectHidden, 130.0) ; break;
					case 16: scroll = new PowerScroll(SkillName.Discordance, 130.0) ; break;
					case 17: scroll = new PowerScroll(SkillName.EvalInt, 130.0) ; break;
					case 18: scroll = new PowerScroll(SkillName.Fencing, 130.0) ; break;
					case 19: scroll = new PowerScroll(SkillName.Fletching, 130.0) ; break;
					case 20: scroll = new PowerScroll(SkillName.Focus, 130.0) ; break;
					case 21: scroll = new PowerScroll(SkillName.Forensics, 130.0) ; break;
					case 22: scroll = new PowerScroll(SkillName.Healing, 130.0) ; break;
					case 23: scroll = new PowerScroll(SkillName.Herding, 130.0) ; break;
					case 24: scroll = new PowerScroll(SkillName.Hiding, 130.0) ; break;
					case 25: scroll = new PowerScroll(SkillName.Inscribe, 130.0) ; break;
					case 26: scroll = new PowerScroll(SkillName.ItemID, 130.0) ; break;
					case 27: scroll = new PowerScroll(SkillName.Lockpicking, 130.0) ; break;
					case 28: scroll = new PowerScroll(SkillName.Lumberjacking, 130.0) ; break;
					case 29: scroll = new PowerScroll(SkillName.Macing, 130.0) ; break;
					case 30: scroll = new PowerScroll(SkillName.Magery, 130.0) ; break;
					case 31: scroll = new PowerScroll(SkillName.MagicResist, 130.0) ; break;
					case 32: scroll = new PowerScroll(SkillName.Meditation, 130.0) ; break;
					case 33: scroll = new PowerScroll(SkillName.Mining, 130.0) ; break;
					case 34: scroll = new PowerScroll(SkillName.Musicianship, 130.0) ; break;
					case 35: scroll = new PowerScroll(SkillName.Fishing, 130.0) ; break;
					case 36: scroll = new PowerScroll(SkillName.Necromancy, 130.0) ; break;
					case 37: scroll = new PowerScroll(SkillName.Ninjitsu, 130.0) ; break;
					case 38: scroll = new PowerScroll(SkillName.Parry, 130.0) ; break;
					case 39: scroll = new PowerScroll(SkillName.Peacemaking, 130.0) ; break;
					case 40: scroll = new PowerScroll(SkillName.Poisoning, 130.0) ; break;
					case 41: scroll = new PowerScroll(SkillName.Provocation, 130.0) ; break;
					case 42: scroll = new PowerScroll(SkillName.RemoveTrap, 130.0) ; break;
					case 43: scroll = new PowerScroll(SkillName.Snooping, 130.0) ; break;
					case 44: scroll = new PowerScroll(SkillName.Spellweaving, 130.0) ; break;
					case 45: scroll = new PowerScroll(SkillName.SpiritSpeak, 130.0) ; break;
					case 46: scroll = new PowerScroll(SkillName.Stealing, 130.0) ; break;
					case 47: scroll = new PowerScroll(SkillName.Stealth, 130.0) ; break;
					case 48: scroll = new PowerScroll(SkillName.Swords, 130.0) ; break;
					case 49: scroll = new PowerScroll(SkillName.Tactics, 130.0) ; break;
					case 50: scroll = new PowerScroll(SkillName.Tailoring, 130.0) ; break;
					case 51: scroll = new PowerScroll(SkillName.TasteID, 130.0) ; break;
					case 52: scroll = new PowerScroll(SkillName.Tinkering, 130.0) ; break;
					case 53: scroll = new PowerScroll(SkillName.Tracking, 130.0) ; break;
					case 54: scroll = new PowerScroll(SkillName.Veterinary, 130.0) ; break;
					case 55: scroll = new PowerScroll(SkillName.Wrestling, 130.0) ; break;
					case 56: return;
				}
	...
	public class PowerScrollChoice130 : Item
	{
		private double m_DeedLevel = 130.0;
		...
		[Constructable]
		public PowerScrollChoice130() : this ( 130.0 )
		{
		}
		
		[Constructable]
		public PowerScrollChoice130(double SkillLvl) : base( 0x14F0 )
		{
		...
		public PowerScrollChoice130( Serial serial ) : base( serial ) { }
		...
		{
			private Mobile m_From;
			private PowerScrollChoice130 m_Deed;
			private double m_DeedLevel;

			public PowerScrollPicker(Mobile from , PowerScrollChoice130 deed, double DeedLevel) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
