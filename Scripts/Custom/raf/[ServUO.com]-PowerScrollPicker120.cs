...
{
	public class ChampionPowerScroll120 : Item
	{
		[Constructable]
		public ChampionPowerScroll120() : base( 0x14F0 )
		{
			Name = "Champion Power Scroll 120";
			Weight = 1.0;
			Hue = 88;
			ItemID = 8707;
		}
		
		public ChampionPowerScroll120( Serial serial ) : base( serial ) { }
		...
		private class PowerScrollPicker : Gump
		{
			...
			private ChampionPowerScroll120 m_Deed;

			public PowerScrollPicker(Mobile from , ChampionPowerScroll120 deed) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
