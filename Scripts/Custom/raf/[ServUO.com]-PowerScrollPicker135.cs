...
namespace Server.Items
{
	public class ChampionPowerScroll : Item
	{
		...
		{
			Name = "Champion Power Scroll 135";
			Weight = 1.0;
			Hue = 88;
			ItemID = 8707;
		}
		...
		private class PowerScrollPicker : Gump
		{
			...
			public PowerScrollPicker(Mobile from , ChampionPowerScroll deed) : base( 50, 50 )
			{
				...
				AddLabel(128, 17, 52, @"Choose  a  135  Power  Scroll");
			...
			public override void OnResponse(NetState sender, RelayInfo info)
			{
				...
				{
					case 0: return;
					case 1: scroll = new PowerScroll(SkillName.Alchemy, 135.0) ; break;
					case 2: scroll = new PowerScroll(SkillName.Anatomy, 135.0) ; break;
					case 3: scroll = new PowerScroll(SkillName.AnimalLore, 135.0) ; break;
					case 4: scroll = new PowerScroll(SkillName.AnimalTaming, 135.0) ; break;
					case 5: scroll = new PowerScroll(SkillName.Archery, 135.0) ; break;
					case 6: scroll = new PowerScroll(SkillName.ArmsLore, 135.0) ; break;
					case 7: scroll = new PowerScroll(SkillName.Begging, 135.0) ; break;
					case 8: scroll = new PowerScroll(SkillName.Blacksmith, 135.0) ; break;
					case 9: scroll = new PowerScroll(SkillName.Bushido, 135.0) ; break;
					case 10: scroll = new PowerScroll(SkillName.Camping, 135.0) ; break;
					case 11: scroll = new PowerScroll(SkillName.Carpentry, 135.0) ; break;
					case 12: scroll = new PowerScroll(SkillName.Cartography, 135.0) ; break;
					case 13: scroll = new PowerScroll(SkillName.Chivalry, 135.0) ; break;
					case 14: scroll = new PowerScroll(SkillName.Cooking, 135.0) ; break;
					case 15: scroll = new PowerScroll(SkillName.DetectHidden, 135.0) ; break;
					case 16: scroll = new PowerScroll(SkillName.Discordance, 135.0) ; break;
					case 17: scroll = new PowerScroll(SkillName.EvalInt, 135.0) ; break;
					case 18: scroll = new PowerScroll(SkillName.Fencing, 135.0) ; break;
					case 19: scroll = new PowerScroll(SkillName.Fletching, 135.0) ; break;
					case 20: scroll = new PowerScroll(SkillName.Focus, 135.0) ; break;
					case 21: scroll = new PowerScroll(SkillName.Forensics, 135.0) ; break;
					case 22: scroll = new PowerScroll(SkillName.Healing, 135.0) ; break;
					case 23: scroll = new PowerScroll(SkillName.Herding, 135.0) ; break;
					case 24: scroll = new PowerScroll(SkillName.Hiding, 135.0) ; break;
					case 25: scroll = new PowerScroll(SkillName.Inscribe, 135.0) ; break;
					case 26: scroll = new PowerScroll(SkillName.ItemID, 135.0) ; break;
					case 27: scroll = new PowerScroll(SkillName.Lockpicking, 135.0) ; break;
					case 28: scroll = new PowerScroll(SkillName.Lumberjacking, 135.0) ; break;
					case 29: scroll = new PowerScroll(SkillName.Macing, 135.0) ; break;
					case 30: scroll = new PowerScroll(SkillName.Magery, 135.0) ; break;
					case 31: scroll = new PowerScroll(SkillName.MagicResist, 135.0) ; break;
					case 32: scroll = new PowerScroll(SkillName.Meditation, 135.0) ; break;
					case 33: scroll = new PowerScroll(SkillName.Mining, 135.0) ; break;
					case 34: scroll = new PowerScroll(SkillName.Musicianship, 135.0) ; break;
					case 35: scroll = new PowerScroll(SkillName.Fishing, 135.0) ; break;
					case 36: scroll = new PowerScroll(SkillName.Necromancy, 135.0) ; break;
					case 37: scroll = new PowerScroll(SkillName.Ninjitsu, 135.0) ; break;
					case 38: scroll = new PowerScroll(SkillName.Parry, 135.0) ; break;
					case 39: scroll = new PowerScroll(SkillName.Peacemaking, 135.0) ; break;
					case 40: scroll = new PowerScroll(SkillName.Poisoning, 135.0) ; break;
					case 41: scroll = new PowerScroll(SkillName.Provocation, 135.0) ; break;
					case 42: scroll = new PowerScroll(SkillName.RemoveTrap, 135.0) ; break;
					case 43: scroll = new PowerScroll(SkillName.Snooping, 135.0) ; break;
					case 44: scroll = new PowerScroll(SkillName.Spellweaving, 135.0) ; break;
					case 45: scroll = new PowerScroll(SkillName.SpiritSpeak, 135.0) ; break;
					case 46: scroll = new PowerScroll(SkillName.Stealing, 135.0) ; break;
					case 47: scroll = new PowerScroll(SkillName.Stealth, 135.0) ; break;
					case 48: scroll = new PowerScroll(SkillName.Swords, 135.0) ; break;
					case 49: scroll = new PowerScroll(SkillName.Tactics, 135.0) ; break;
					case 50: scroll = new PowerScroll(SkillName.Tailoring, 135.0) ; break;
					case 51: scroll = new PowerScroll(SkillName.TasteID, 135.0) ; break;
					case 52: scroll = new PowerScroll(SkillName.Tinkering, 135.0) ; break;
					case 53: scroll = new PowerScroll(SkillName.Tracking, 135.0) ; break;
					case 54: scroll = new PowerScroll(SkillName.Veterinary, 135.0) ; break;
					case 55: scroll = new PowerScroll(SkillName.Wrestling, 135.0) ; break;
					case 56: return;
				}
	...
	public class PowerScrollChoice135 : Item
	{
		private double m_DeedLevel = 135.0;
		...
		[Constructable]
		public PowerScrollChoice135() : this ( 135.0 )
		{
		}
		
		[Constructable]
		public PowerScrollChoice135(double SkillLvl) : base( 0x14F0 )
		{
		...
		public PowerScrollChoice135( Serial serial ) : base( serial ) { }
		...
		{
			private Mobile m_From;
			private PowerScrollChoice135 m_Deed;
			private double m_DeedLevel;

			public PowerScrollPicker(Mobile from , PowerScrollChoice135 deed, double DeedLevel) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
