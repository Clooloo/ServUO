...
namespace Server.Items
{
	...
	public override bool IsDecoContainer
		...
		public override bool OnDragDrop( Mobile from, Item dropped )
		{
			...
			{
				from.SendMessage( "Items will delete in 5 Minutes!" ); // The item will be deleted in three minutes
		...
		private class EmptyTimer : Timer
		{
			...
			public EmptyTimer( TrashPack pack ) : base( TimeSpan.FromMinutes( 5.0 ) )
			{
				m_Pack = pack;
