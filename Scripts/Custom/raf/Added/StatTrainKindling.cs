...
{
    public class StatTrainKindling : Item
    {
        [Constructable]
        public StatTrainKindling()
            : this(1)
        {
			this.LootType = LootType.Blessed;
			this.Name = "Stat Train Kindling";			
        }

        [Constructable]
        public StatTrainKindling(int amount)
            : base(0xDE1)
        {
            Stackable = false;
            Weight = 1.0;
        ...
        public StatTrainKindling(Serial serial)
            : base(serial)
        {
        }
