...
{
    [CorpseName( "corpse of Bahamut Zero" )]
    public class BahamutZERO : BaseCreature
    {
		...
		private static Type[] m_ArtifactRarity1000 = new Type[]
			{
				typeof( SephirothRing ),
				typeof( ItemBlessDeed ),                
				typeof( SephirothSkirt )
			};
		...
		public override void OnDeath( Container c )
		{
			...
			if ( !Summoned && !NoKillAwards && BahamutZERO.CheckArtifactChance( this ) )
				BahamutZERO.DistributeArtifact( this );
		}
        ...
        [Constructable]
        public BahamutZERO() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "Bahamut ZERO";
            Hue = 1616;
	    Body = 12;
            ...
            SetStr(2000);//Adjust this to fit your shard.
            SetDex(4000);//Adjust this to fit your shard.
            SetInt(13000);//Adjust this to fit your shard.

            SetHits(130000);//Adjust this to fit your shard.

            SetDamage(418, 429);//Adjust this to fit your shard.

            SetDamageType(ResistanceType.Energy, 80);//Adjust this to fit your shard.

            SetResistance(ResistanceType.Physical, 80);//Adjust this to fit your shard.
            SetResistance(ResistanceType.Fire, 80);//Adjust this to fit your shard.
            SetResistance(ResistanceType.Poison, 80);//Adjust this to fit your shard.
            SetResistance(ResistanceType.Energy, 80);//Adjust this to fit your shard.

            SetSkill(SkillName.EvalInt, 330);//Adjust this to fit your shard.
            SetSkill(SkillName.Tactics, 340);//Adjust this to fit your shard.
            SetSkill(SkillName.MagicResist, 230);//Adjust this to fit your shard.
            SetSkill(SkillName.Wrestling, 650);//Adjust this to fit your shard.
            SetSkill(SkillName.Meditation, 600);//Adjust this to fit your shard.
            SetSkill(SkillName.Focus, 400);//Adjust this to fit your shard.
            SetSkill(SkillName.Magery, 250);//Adjust this to fit your shard.

            Fame = 2500;//Adjust this to fit your shard.
            Karma = -2500;//Adjust this to fit your shard.

            VirtualArmor = 10;//Adjust this to fit your shard.
        ...
        public BahamutZERO(Serial serial) : base(serial)
        {
        }
