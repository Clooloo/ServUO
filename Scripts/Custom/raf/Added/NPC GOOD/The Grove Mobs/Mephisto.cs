...
{
	public class Mephisto : BaseCreature
	{
		...
		[Constructable]
		public Mephisto() : base( AIType.AI_Mage, FightMode.Closest, 18, 1, 0.2, 0.4 )
		{
			...
			if (Utility.Random(100) < 98)
            		{
                		...
                		switch (Utility.Random(31))
                		{
                    			...
                    			case 27: AddToBackpack(new PowerScroll(SkillName.AnimalTaming, level)); break;
                    			case 28: AddToBackpack(new PowerScroll(SkillName.AnimalLore, level)); break;
                    			case 29: AddToBackpack(new PowerScroll(SkillName.Throwing, level)); break; 
                                case 30: AddToBackpack(new PowerScroll(SkillName.Mysticism, level)); break; 
                		}
            		}
		...
		public Mephisto( Serial serial ) : base( serial )
		{
			m_Instances.Add( this );
		}
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.WriteMobileList<voodoo>( m_Spirits );
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				case 0:
				{
					...
					m_Spirits = reader.ReadStrongMobileList<voodoo>();
	...
	[CorpseName( "a Voodoo corpse" )]
	public class voodoo : BaseCreature
	{
		private Mobile m_Mephisto;

		private DrainTimer m_Timer;

		[CommandProperty( AccessLevel.GameMaster )]
		public Mobile Mephisto
		{
			get
			{
				return m_Mephisto;
		...
		[Constructable]
		public voodoo() : this( null )
		{
		}
		
		public voodoo( Mobile Mephisto ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			m_Mephisto = Mephisto;
       ...
       public override void OnDamage(int amount, Mobile from, bool willKill)
		...
		public voodoo( Serial serial ) : base( serial )
		{
		}
		...
		{
			private voodoo m_Owner;

			public DrainTimer( voodoo owner ) : base( TimeSpan.FromSeconds( 5.0 ), TimeSpan.FromSeconds( 5.0 ) )
			{
				m_Owner = owner;
				Priority = TimerPriority.TwoFiftyMS;
			}
			...
			protected override void OnTick()
			{
				...
				{
					if ( m == m_Owner || m == m_Owner.Mephisto || !m_Owner.CanBeHarmful( m ) )
						continue;
				...
				foreach ( Mobile m in m_ToDrain )
				{
					...
					if ( m_Owner.Mephisto != null )
						m_Owner.Mephisto.Hits += drain;
