...
{
	public class RoughJason : BaseCreature
	{
		...
		[Constructable]
		public RoughJason() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			m_Instances.Add( this );

 
			Name = " Friday the 13th -Jason-  ";
			Hue = 1579;
			Body = 280;
			BaseSoundID = 367;
      ...
      //      }
		...
		public RoughJason( Serial serial ) : base( serial )
		{
			m_Instances.Add( this );
		}
...
{
	public class JasonAxeThrow : HHatchet
	{
        ...
        public JasonAxeThrow( Serial serial ) : base( serial )
		{
		}
