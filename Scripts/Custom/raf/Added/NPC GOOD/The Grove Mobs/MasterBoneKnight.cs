...
namespace Server.Mobiles
{
	...
	public class MasterBoneKnight : BaseCreature
	{
		[Constructable]
		public MasterBoneKnight() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "A Master Bone Knight";
			Body = 57;
			BaseSoundID = 451;
            Hue = 1970;
			...
			SetResistance( ResistanceType.Physical, 15, 45 );
		...
		public MasterBoneKnight( Serial serial ) : base( serial )
		{
		}
