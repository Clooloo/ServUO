...
namespace Server.Mobiles
{
	...
	public class Ccold : BaseCreature
	{
	    ...
	    BaseSoundID = 367;
			...
			this.SetSkill(SkillName.Mysticism, 130);
			this.SetSkill(SkillName.Focus, 300);
			this.SetSkill(SkillName.Meditation, 120);
			this.SetSkill(SkillName.Wrestling, 140);
       ...
       private class InternalTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                AOS.Damage(this.m_Mobile, this.m_From, Utility.RandomMinMax(110, 140), 0, 100, 0, 0, 0);
            }
        }


        public Ccold(Serial serial): base(serial)
