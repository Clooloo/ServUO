...
{
	public class HeroCurrencyMage : Item
	{
		...
		[Constructable]
		public HeroCurrencyMage() : this( 1 )
		{
		}

		[Constructable]
		public HeroCurrencyMage( int amount ) : base( 0x3196 )
		{
            Name = "Hero Currency Mage";
            Hue = 1631; 
			Stackable = true;
		...
		{ 
			...
			{ 
                ...
                this.Name = "Hero " + from.Name.ToString() + "'s Mage Currency";//Change item name and add who it is bound to.
		...
		public HeroCurrencyMage( Serial serial ) : base( serial )
		{
		}
