...
{
	public class HeroCurrencyTamer : Item
	{
		...
		[Constructable]
		public HeroCurrencyTamer() : this( 1 )
		{
		}

		[Constructable]
		public HeroCurrencyTamer( int amount ) : base( 0x3196 )
		{
            Name = "Hero Currency Tamer";
            Hue = 1631; 
			Stackable = true;
		...
		{ 
			...
			{ 
                ...
                this.Name = "Hero " + from.Name.ToString() + "'s Tamer Currency";//Change item name and add who it is bound to.
		...
		public HeroCurrencyTamer( Serial serial ) : base( serial )
		{
		}
