...
{
	public class HeroCurrencyAlche : Item
	{
		...
		[Constructable]
		public HeroCurrencyAlche() : this( 1 )
		{
		}

		[Constructable]
		public HeroCurrencyAlche( int amount ) : base( 0x3196 )
		{
            Name = "Hero Currency Alchemist";
            Hue = 1631; 
			Stackable = true;
		...
		{ 
			...
			{ 
                ...
                this.Name = "Hero " + from.Name.ToString() + "'s Alchemy Currency";//Change item name and add who it is bound to.
		...
		public HeroCurrencyAlche( Serial serial ) : base( serial )
		{
		}
