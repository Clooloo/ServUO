...
namespace Server
{
    public class RulesGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            this.AddPage(1);
            this.AddLabel(313, 84, 67, @"Welcome to Your shard!");
