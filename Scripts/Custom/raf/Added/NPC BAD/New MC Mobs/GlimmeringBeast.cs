...
{
    [CorpseName("a glimmering beast corpse")]
    public class GlimmeringBeast : BaseCreature, IDevourer
    {
        ...
        [Constructable]
        public GlimmeringBeast()
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Name = "a glimmering beast";
            this.Body = 775;
        ...
        public GlimmeringBeast(Serial serial)
            : base(serial)
        {
        }
