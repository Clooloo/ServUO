...
namespace Server.Items
{
    ...
    public class PlatinumLockpick : Item
    {
            ...
            : base(0x14FC)
        {
            ...
            Hue = 2499;
			Name = "Platinum Lockpick";
        }

        public PlatinumLockpick(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            private PlatinumLockpick m_Item;

            public InternalTarget(PlatinumLockpick item)
