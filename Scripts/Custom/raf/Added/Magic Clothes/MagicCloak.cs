		...
		public MagicCloak() : base( 0x1515 )
		{
                       ...
                       switch ( Utility.Random( 53 ) )   
			{
				...
				case 2: SkillBonuses.SetValues( 0, SkillName.AnimalLore, val ); break;
                                case 3: SkillBonuses.SetValues( 0, SkillName.Macing, val ); break;
				case 4: SkillBonuses.SetValues( 0, SkillName.ArmsLore, val ); break;
                                case 5: SkillBonuses.SetValues( 0, SkillName.Parry, val ); break;
                                case 6: SkillBonuses.SetValues( 0, SkillName.Fencing, val ); break;
				...
				case 10: SkillBonuses.SetValues( 0,SkillName.Swords, val ); break;
				case 11: SkillBonuses.SetValues( 0,SkillName.Carpentry, val ); break;
                                case 12: SkillBonuses.SetValues( 0,SkillName.Tactics, val ); break;
				case 13: SkillBonuses.SetValues( 0,SkillName.Bushido, val ); break;
				case 14: SkillBonuses.SetValues( 0,SkillName.Ninjitsu, val ); break;
				...
				case 18: SkillBonuses.SetValues( 0,SkillName.EvalInt, val ); break;
				case 19: SkillBonuses.SetValues( 0,SkillName.Stealth, val ); break;
				...
				case 27: SkillBonuses.SetValues( 0,SkillName.Macing, val ); break;
				...
				case 34: SkillBonuses.SetValues( 0,SkillName.AnimalTaming, val ); break;
                                case 35: SkillBonuses.SetValues( 0,SkillName.Swords, val ); break;
				case 36: SkillBonuses.SetValues( 0,SkillName.Tinkering, val ); break;
				case 37: SkillBonuses.SetValues( 0,SkillName.Fencing , val ); break;
				...
				case 46: SkillBonuses.SetValues( 0,SkillName.Stealth, val ); break;
                                case 47: SkillBonuses.SetValues( 0,SkillName.Throwing, val ); break;
